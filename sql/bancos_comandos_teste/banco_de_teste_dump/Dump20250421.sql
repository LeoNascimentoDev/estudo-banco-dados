...
INSERT INTO `cidades` VALUES (1,'São Paulo',49,1521.11,12.33),(2,'Rio de Janeiro',19,1182.99,6.74);
...
CREATE TABLE `estados` (
  ...
  `sigla` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `regiao` enum('NORTE','NORDESTE','SUDESTE','CENTRO_OESTE','SUL') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `prefeitos` VALUES (1,'Albert',1),(2,'Bento',2),(3,'Carlos',NULL);
...
-- Dump completed on 2025-04-21 19:47:40
